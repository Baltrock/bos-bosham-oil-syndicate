...
class DashboardFormsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update dashboard_form" do
    patch dashboard_form_url(@dashboard_form), params: { dashboard_form: { address: @dashboard_form.address, comment: @dashboard_form.comment, company_name: @dashboard_form.company_name, pounds_per_litre: @dashboard_form.pounds_per_litre, rating: @dashboard_form.rating } }
